        ...
        if (!plansExist)
        {
            ...
            var platformPlans = new List<PlatformPlan>
            {
                new PlatformPlan
                {
                    ...
                    StripePriceId = "price_1SrVIDFORaGTWCJoRacOM7AD",
                },
                new PlatformPlan
                {
                    Id = Guid.NewGuid().ToString(),
                    ...
                    StripePriceId = "price_1SrVIEFORaGTWCJoWkekFucb",
                },
                new PlatformPlan
                {
                    Id = Guid.NewGuid().ToString(),
                    ...
                    StripePriceId = "price_1SrVIFFORaGTWCJoefnaq7pz",
                }
            };
    ...
    )
    {
        ...
        try
        {
            ...
            if (!tenantExists)
            {
                ...
                _logger.LogInformation("Access the tenant at: http://{Subdomain}.hubletix.home:5000", tenant.Identifier);
            }
            else
            {
