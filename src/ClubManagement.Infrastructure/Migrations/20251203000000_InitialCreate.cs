        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MembershipSubscriptions_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EventSignups_EventSchedules_ScheduleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventSchedules_EventId_DateTimeStart",
                table: "EventSchedules",
                columns: new[] { "EventId", "DateTimeStart" });

            migrationBuilder.CreateIndex(
                name: "IX_EventSignups_ScheduleId_UserId",
                table: "EventSignups",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MembershipSubscriptions_StripeSubscriptionId",
                table: "MembershipSubscriptions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentRecords_StripePaymentId",
                table: "PaymentRecords",
                columns: new[] { "StripePaymentId" },
                unique: true);
